...
public class AuthController : ControllerBase
{
    ...
    private readonly ParafiaDbDataContext _context;
    private readonly TokenService _tokenService;

    public AuthController(UserManager<IdentityUser> userManager, ParafiaDbDataContext context, TokenService tokenService)
    {
